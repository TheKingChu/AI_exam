...
public class ZombieChaseState_Part4 : State_Part4
{
    public ZombieChaseState_Part4(GameObject _zombie, NavMeshAgent _agent, Transform _human1, Transform _human2, Transform _human3, Transform _human4, GameObject _canvas, int _health) :
    ...
    public override void Update()
    {
        ...
        if (agent.hasPath) //if its following the player
        {
            ...
            {
                nextState = new ZombieFlockState_Part4(zombie, agent, human1, human2,human3,human4,canvas, health);
                stage = Event.Exit;
            }
