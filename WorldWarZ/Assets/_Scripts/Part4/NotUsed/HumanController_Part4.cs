...
public class HumanController_Part4 : MonoBehaviour
{
    public Weapon_Part3 _weapon;
    [SerializeField] ZombieController_Part3 _zombie;
    NavMeshAgent humanAgent;
    Vector3 safeZone;

    public List<Transform> zombie = new List<Transform>();
    ...
    public Transform GetClosestEnemy(List<Transform> zombie)
    {
        ...
        {
            Vector3 directionToTarget = zombie[i].position - currentPosition;
