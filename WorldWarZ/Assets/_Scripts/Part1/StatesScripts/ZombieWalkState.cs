...
public class ZombieWalkState : State
{
    int currentIndex = -1;

    public ZombieWalkState(GameObject _zombie, NavMeshAgent _agent, Transform _human, GameObject _canvas, int _health) : base(_zombie, _agent, _human, _canvas, _health)
    {
        state = States.Walk;
        agent.speed = 5;
